...
fun EditShortcutDialog(
    ...
    var shortcutName by remember(shortcut) { mutableStateOf(shortcut.name) }
    var shortcutPrompt by remember(shortcut) { mutableStateOf(shortcut.prompt) }
    var useChatGPT by remember(shortcut) { mutableStateOf(shortcut.useChatGPT) }
